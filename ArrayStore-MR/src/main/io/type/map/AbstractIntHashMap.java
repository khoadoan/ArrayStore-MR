...
public abstract class AbstractIntHashMap extends AbstractMap {
  /**
   * 
   */
   ...
   *            value.
   */
  public void assign(final cern.colt.function.tdouble.DoubleFunction function) {
      copy().forEachPair(new cern.colt.function.tdouble.IntDoubleProcedure() {
   ...
   */
  public AbstractIntHashMap copy() {
      return (AbstractIntHashMap) clone();
  }
  ...
  public boolean equals(Object obj) {
      ...
      if (!(obj instanceof AbstractIntHashMap))
          return false;
      final AbstractIntHashMap other = (AbstractIntHashMap) obj;
      if (other.size() != size())
          return false;
