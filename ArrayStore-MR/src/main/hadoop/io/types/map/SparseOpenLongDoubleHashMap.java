...
public class SparseOpenLongDoubleHashMap extends AbstractLongDoubleMap implements Writable{
  public static final double NULL = Double.NaN;
  public static final int arrayDefaultCapacity = 10000;
  /**
   * 
   */
   ...
   */
  public SparseOpenLongDoubleHashMap() {
      this(arrayDefaultCapacity);
  }
   ...
   */
  public SparseOpenLongDoubleHashMap(int initialCapacity) {
   ...
   *             .
   */
  public SparseOpenLongDoubleHashMap(int initialCapacity, double minLoadFactor, double maxLoadFactor) {
  ...
  public void assign(AbstractLongDoubleMap other) {
      if (!(other instanceof SparseOpenLongDoubleHashMap)) {
          super.assign(other);
          return;
      }
      SparseOpenLongDoubleHashMap source = (SparseOpenLongDoubleHashMap) other;
      SparseOpenLongDoubleHashMap copy = (SparseOpenLongDoubleHashMap) source.copy();
  ...
  public Object clone() {
      SparseOpenLongDoubleHashMap copy = (SparseOpenLongDoubleHashMap) super.clone();
  ...
  public void pairsMatching(final LongDoubleProcedure condition, final LongArrayList keyList,
  ...
  public boolean put(long key, double value) {
      ...
      if (i < 0) { // already contained
          i = -i - 1;
          // if (debug) if (this.state[i] != FULL) throw new LongernalError();
          // if (debug) if (this.table[i] != key) throw new LongernalError();
          this.values[i] = value;
          return false;
      }
  ...
  public boolean removeKey(long key) {
      ...
      // if (debug) if (this.state[i] == FREE) throw new LongernalError();
      // if (debug) if (this.state[i] == REMOVED) throw new LongernalError();
  ...
  public void write(DataOutput out) throws IOException {
    ...
    for (int i = 0; i < table.length; i++) {
      WritableUtils.writeVLong(out, table[i]);
    }
  ...
  public void readFields(DataInput in) throws IOException {
    ...
    this.table = new long[WritableUtils.readVInt(in)];
    for (int i = 0; i < table.length; i++) {
